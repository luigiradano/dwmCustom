...
static const char *mutevol[] = {"/usr/bin/pactl", "set-sink-mute", "0",
                                "toggle", NULL};
static const char *muteMic[] = {"/usr/bin/pactl", "set-source-mute",
...
static const char *playPause[] = {"/usr/bin/playerctl", "-a", "play-pause",
                                  NULL};
...
static const Key keys[] = {
    ...
    {0, XF86XK_AudioMute, spawn, {.v = pavucontrol}},
    {0, XF86XK_AudioRaiseVolume, spawn, {.v = upvol}},
    //	{ 0,                            XF86XK_MonBrightnessUp,
    // spawn,      {.v = upbright } }, 	{ 0, XF86XK_MonBrightnessDown, spawn,
    // {.v = downbright } },
...
static const Button buttons[] = {
    ...
    {ClkStatusText, 0, Button1, spawn, {0}},
